...
<?php ob_start() ?>
	<main>
	    <div class="container-fluid">
	    	<div class="m-0 p-0 text-center" style="display: flex;">
	            ...
	            <p id="text">
	            	403 FORBIDDEN <br>
	            	No posees permisos para ver este contenido >:c
	            </p>
	            <p id="credit" class="d-none">Created with the help of <a href="http://dynamicsjs.com/">Dynamics.js</a></p>
	    	</div>
	    </div>
	</main>
...
<?php ob_start() ?>
	<script type="text/javascript" src="<?= base_url("public/js/dynamics.min.js") ?>"></script>
	<script>
...
<?php require_once base_dir("App/Views/base.php") ?>