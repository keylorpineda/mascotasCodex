...
<html lang="es">
	...
	<body class="sb-nav-fixed">
		...
		<!-- ======= Confirm ======= -->
			<div class="modal" id="confirmar" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-centered">
			    <div class="modal-content">
			      <div class="modal-header" data-confirm-type>
			        <h5 class="modal-title" data-confirm-title></h5>
			        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-label="Close" data-confirm-cancel>
			      ...
			      <div class="modal-footer">
		      	    ...
		      	    <button type="button" class="btn w-100 btn-danger" data-confirm-cancel data-dismiss="modal">Cerrar</button>
		      		</div>
		      		<div class="row w-100" data-confirm-botones-estilo-confirmar>
		      	    <div class="col-md-6 col-sm-6">
		      	    	<button type="button" class="btn w-100" data-confirm-accept data-dismiss="modal">Aceptar</button>
		      	    </div>
		      	    <div class="col-md-6 col-sm-6">
		      	    	<button type="button" class="btn btn-danger w-100" data-confirm-cancel data-dismiss="modal">Cancelar</button>
		      			</div>
		      		</div>
			      </div>
			    </div>
